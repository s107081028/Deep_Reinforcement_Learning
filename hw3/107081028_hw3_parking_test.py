...
class Agent(object):
    def __init__(self):
        self.agent =  DDPGAgent(actor_learning_rate=0.0001, critic_learning_rate=0.0005, n_actions=2,
    ...
    def act(self, observation):
        return self.agent.choose_action(observation["observation"], observation["desired_goal"], False)